package kr.naeseonja.be.server.queue.presentation.api;
...
import kr.naeseonja.be.server.queue.presentation.dto.request.QueueTokenRequest;
import kr.naeseonja.be.server.queue.presentation.dto.response.QueueTokenPositionResponse;
import kr.naeseonja.be.server.queue.presentation.dto.response.QueueTokenResponse;
