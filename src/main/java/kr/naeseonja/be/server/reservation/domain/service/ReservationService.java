package kr.naeseonja.be.server.reservation.domain.service;

import jakarta.transaction.Transactional;
import kr.naeseonja.be.server.reservation.domain.model.Reservation;
import kr.naeseonja.be.server.reservation.domain.repository.ReservationRepository;
import kr.naeseonja.be.server.reservation.exception.ReservationErrorCode;
import kr.naeseonja.be.server.reservation.exception.ReservationException;
