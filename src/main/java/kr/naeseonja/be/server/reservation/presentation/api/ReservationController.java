package kr.naeseonja.be.server.reservation.presentation.api;

import io.swagger.v3.oas.annotations.Operation;
import io.swagger.v3.oas.annotations.tags.Tag;
import kr.naeseonja.be.server.common.dto.CommonResponse;
import kr.naeseonja.be.server.reservation.application.dto.ReservationResult;
import kr.naeseonja.be.server.reservation.application.dto.ReservationTemporaryResult;
import kr.naeseonja.be.server.reservation.application.service.ReservationConfirm;
import kr.naeseonja.be.server.reservation.application.service.ReservationTemporary;
import kr.naeseonja.be.server.reservation.presentation.dto.request.ReservationRequest;
import kr.naeseonja.be.server.reservation.presentation.dto.request.ReservationTemporaryRequest;
import kr.naeseonja.be.server.reservation.presentation.dto.response.ReservationResponse;
import kr.naeseonja.be.server.reservation.presentation.dto.response.ReservationTemporaryResponse;
